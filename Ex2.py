...
fasta_file = os.path.join(script_dir, "A_APOE_mrnas_refseq_variant1.fasta")
output_directory = script_dir
blastp_path = os.path.join(script_dir, "ncbi-blast-2.3.0+","bin", "blastp")

database_path =os.path.join(script_dir, "ncbi-blast-2.3.0+","data", "swissprot") 
